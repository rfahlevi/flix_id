...
class GetTransactions implements Usecase<Result<List<Transaction>>, GetTransactionsParams> {
  ...
  Future<Result<List<Transaction>>> call(GetTransactionsParams params) async {
    var transactionsResult = await _transactionRepository.getUserTransactions(uid: params.uid);
